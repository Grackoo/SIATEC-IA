            ...
            <section className="hero">
                <div className="video-background">
                    <video autoPlay loop muted playsInline className="hero-video">
                        <source src="videos/OPCION 2.mp4" type="video/mp4" />
                ...
                <div className="container relative z-10">
                    <div className="hero-content text-white" data-aos="fade-up">
                        ...
                        <div className="flex w-full gap-4" style={{ flexDirection: 'column', alignItems: 'center' }} data-aos="fade-up" data-aos-delay="400">
